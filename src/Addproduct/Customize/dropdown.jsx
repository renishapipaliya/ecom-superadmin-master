     ...
     <Box>
      ...
      <Box >
            ...
            <TextField
              ...
              size="small"
              variant="outlined"
              sx={{ width: "550px", mt: "5px" }}
              required
            />
      </Box>
      <Box sx={{mt: "28px"}}>
      <Button
  sx={{ height: "38px",width: "150px", marginLeft: "2%", fontSize: "13px"}}
  variant="outlined"
  startIcon={<AddIcon />}
  ...
  Add Variants
      ...
      <Table sx={{ minWidth: 650, }} size="small" aria-label="a dense table">
        ...
        <TableBody>
              {rows.map((row) => (
                <TableRow key={row.id} >
                  <TableCell align="center"><DehazeOutlinedIcon/></TableCell>
                  <TableCell align="center">
                    <TextField 
                    placeholder='Enter Chams name..'></TextField>
                  </TableCell>
